        ...
        <div className='flex flex-col justify-center items-center mx-auto w-5/6 gap-y-4 md:gap-y-12'>
          ...
          <div className='flex flex-col justify-center items-center mx-auto gap-y-6 md:gap-y-16'>
            ...
            <div className='flex flex-col lg:flex-row gap-3'>
              <div>
                <Button bgColor='bg-primary-4' fontColor='text-primary-1' children='SIGN UP' handleClick={function (): void {
                  throw new Error("Function not implemented.");
                }} />
              </div>
              <div>
                <Button bgColor='bg-primary-2' fontColor='text-primary-4' children='SIGN IN' handleClick={function (): void {
                  throw new Error("Function not implemented.");
                }} />
              </div>
            </div>
